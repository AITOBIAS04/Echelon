...
NOTE: This is a backend-local copy of theatre/engine/canonical_json.py
to avoid cross-package imports that break on Railway deployment.
Keep in sync if the theatre version changes.
"""
