...
Echelon_OSINT_Reality_Oracle_Appendix_v3_1 section 2.3 and the
HTTP Transcript Canonical Specification from
Echelon_OSINT_Composed_Oracle_Spec_v2 section 5.
"""
...
class HTTPTranscriptReceipt(BaseModel):
    ...
    See Composed Oracle Spec v2 section 5 for canonical form specification.
    """
...
class EvidenceBundle(BaseModel):
    ...
    See OSINT Reality Oracle Appendix v3.1 section 2.3.
    """
...
class OracleCollectionSummary(BaseModel):
    ...
    def distinct_upstream_count(self) -> int:
        """Count distinct independence_upstream_id values across bundles.
