...
export function LiveNowBar({ liveNow }: LiveNowBarProps) {
  ...
  return (
    <div className="bg-[#111111] border border-[#1A1A1A] rounded-lg p-4 mb-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 bg-terminal-bg border border-terminal-border rounded hover:border-[#00D4FF] hover:text-[#00D4FF] transition group"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 bg-terminal-bg border border-terminal-border rounded hover:border-[#FF3B3B] hover:text-[#FF3B3B] transition group"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 bg-terminal-bg border border-terminal-border rounded hover:border-amber-500 hover:text-amber-500 transition group"
        >
